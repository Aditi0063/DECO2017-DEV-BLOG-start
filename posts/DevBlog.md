...
Target Audience:  Indie game enthusiasts and gamers, a loyal and passionate community that seek niche platforms for discussions. 

Strength: The trust mechanic for longer reviews must be earned through community validation, which incentivises quality of reviews and honesty. 

Risks: is the badge. If the goal is set too high, nobody will earn one and the system will feel broken. If too low, badge’s value become meaningless. User testing would be able to resolve this problem. The rating system requires careful handling, users shouldn’t be able to rate their own decriptions and individual ratings shouldn’t be publicly visible to prevent social pressure. 
